...
{
    public class OpenSslLib32Provider : CertificateProvider
    {
        ...
        public OpenSslLib32Provider(IDictionary<string, string> initParams)
            : base(initParams)
        { }
        ...
        private int DefaultRsaKeyGeneratorCallback(int p, int n, object cbArg)
        {
        ...
        private string DefaultPasswordHandler(bool verify, object arg)
        {
